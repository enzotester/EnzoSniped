...
""")
    ...
    def _print_stats(self) -> None:
        ...
        print(Style.BRIGHT + f"[ Total buys: {Fore.BLUE}{Style.BRIGHT}{self.buys}{Fore.BLUE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"[ Last Speed: {Fore.BLUE}{Style.BRIGHT}{self.last_time}{Fore.BLUE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"[ Total price checks: {Fore.BLUE}{Style.BRIGHT}{self.checks}{Fore.BLUE}{Style.BRIGHT} ]")
